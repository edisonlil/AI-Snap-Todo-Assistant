...
def build_work_order_payload(event: TodoDomainEvent) -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        ...
        "customer_environment_code": _first_meaningful(fields.get("customer_environment_code")),
        "customer_environment_value": _first_meaningful(fields.get("customer_environment_value")),
...
def todo_from_server_work_order(item: dict[str, Any]) -> TodoItem:
    ...
    return TodoItem(
        ...
        summary_fields=TicketSummaryFields(
            ...
            customer_environment_value=_clean(item.get("customer_environment_value")),
            ach_no=_clean(item.get("ach_order_no")),
