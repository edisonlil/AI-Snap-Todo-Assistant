...
def build_todo_item(
    *,
    ...
    summary_fields = build_summary_fields(
        ...
        product_module=str(todo_row.get("product_module", "")),
        ticket_type=str(todo_row.get("ticket_type", "")),
        reproduction_probability=str(todo_row.get("reproduction_probability", "")),
        customer_environment_code=str(todo_row.get("customer_environment_code", "")),
        customer_environment_value=str(todo_row.get("customer_environment_value", "")),
        issue_product=str(todo_row.get("issue_product", "")),
